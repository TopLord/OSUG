...
namespace S1
{
	public class Player_DetectItem : MonoBehaviour {
		...
		//store spherecast reference in this varaible
		...
		void CheckForItemPickupAttempt(){
			//Time.Scale so player cannot pickup item while game is paused, !=GameManager_References._playerTag so player cannot pickup wielded weapon
